...
import { generateImageAction } from "@/app/api/fal/actions";
import { handleFalError } from "@/app/api/fal/helpers";
...
export function RealisticImage() {
      ...
      reader.onload = async (e) => {
        try {
          ...
          if (!uploadResult.imageUrl) {
            setError("Missing image url in result");
            setIsGenerating(false);
            return;
          }
      ...
      {selectedImage && (
        <div className="rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Click the button below to transform your image into a realistic
            photo.
          </p>
          <button
            type="button"
        ...
        <div className="rounded-lg shadow-lg p-6">
          ...
          <div className="text-center">
            <Image
              fill
              src={generatedImage}
              alt="Convert into realistic style"
