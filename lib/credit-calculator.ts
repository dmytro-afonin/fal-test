export function calculateCreditCost(baseCost: number, width: number, height: number): number {
 ...
 */
export async function getImageDimensions(source: File | string): Promise<{ width: number; height: number }> {
